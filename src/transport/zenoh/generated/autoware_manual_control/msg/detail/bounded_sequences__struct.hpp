...
#ifndef AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
#define AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_manual_control__msg__BoundedSequences __attribute__((deprecated))
#else
# define DEPRECATED__autoware_manual_control__msg__BoundedSequences __declspec(deprecated)
#endif
...
struct BoundedSequences_
{
  ...
  using _string_values_type =
    rosidl_runtime_cpp::BoundedVector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>>;
  _string_values_type string_values;
  using _basic_types_values_type =
    rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::Constants_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::Constants_<ContainerAllocator>>>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::Defaults_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::Defaults_<ContainerAllocator>>>;
  ...
  Type & set__basic_types_values(
    const rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::Constants_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::Constants_<ContainerAllocator>>> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const rosidl_runtime_cpp::BoundedVector<autoware_manual_control::msg::Defaults_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_manual_control::msg::Defaults_<ContainerAllocator>>> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_manual_control::msg::BoundedSequences_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_manual_control__msg__BoundedSequences
    std::shared_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_manual_control__msg__BoundedSequences
    std::shared_ptr<autoware_manual_control::msg::BoundedSequences_<ContainerAllocator> const>
...
using BoundedSequences =
  autoware_manual_control::msg::BoundedSequences_<std::allocator<void>>;
...
#endif  // AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BOUNDED_SEQUENCES__STRUCT_HPP_
