...
#include "autoware_manual_control/msg/detail/unbounded_sequences__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::BasicTypes &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::BasicTypes &);
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::Constants &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::Constants &);
size_t get_serialized_size(
  const autoware_manual_control::msg::Constants &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::Defaults &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::Defaults &);
size_t get_serialized_size(
  const autoware_manual_control::msg::Defaults &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const autoware_manual_control::msg::UnboundedSequences & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::UnboundedSequences & ros_message)
{
  // Member: bool_values
  {
    cdr >> ros_message.bool_values;
  ...
  size_t current_alignment)
{
  ...
  // Member: basic_types_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_BasicTypes(
  ...
  // Member: constants_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Constants(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: defaults_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Defaults(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::UnboundedSequences;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::UnboundedSequences *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::UnboundedSequences *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::UnboundedSequences>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_UnboundedSequences__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, UnboundedSequences)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_UnboundedSequences__handle;
}
