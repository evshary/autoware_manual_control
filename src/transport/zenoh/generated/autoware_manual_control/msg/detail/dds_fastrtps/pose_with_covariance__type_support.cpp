...
#include "autoware_manual_control/msg/detail/pose_with_covariance__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::Pose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::Pose &);
...
cdr_serialize(
  const autoware_manual_control::msg::PoseWithCovariance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::PoseWithCovariance & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  // Member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::PoseWithCovariance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::PoseWithCovariance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::PoseWithCovariance *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::PoseWithCovariance>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_PoseWithCovariance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, PoseWithCovariance)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_PoseWithCovariance__handle;
}
