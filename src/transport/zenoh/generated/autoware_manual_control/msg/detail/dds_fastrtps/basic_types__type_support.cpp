...
cdr_serialize(
  const autoware_manual_control::msg::BasicTypes & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::BasicTypes & ros_message)
{
  // Member: bool_value
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::BasicTypes;
    is_plain =
      (
...
static bool _BasicTypes__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::BasicTypes *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _BasicTypes__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::BasicTypes *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BasicTypes__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::BasicTypes *>(
...
static size_t _BasicTypes__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_BasicTypes(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BasicTypes__callbacks = {
  "autoware_manual_control::msg",
  "BasicTypes",
  _BasicTypes__cdr_serialize,
  _BasicTypes__cdr_deserialize,
  _BasicTypes__get_serialized_size,
  _BasicTypes__max_serialized_size
};

static rosidl_message_type_support_t _BasicTypes__handle = {
...
get_message_type_support_handle<autoware_manual_control::msg::BasicTypes>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_BasicTypes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, BasicTypes)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_BasicTypes__handle;
}
