...
#include "autoware_manual_control/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_manual_control::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::Point & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::Point *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::Point>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, Point)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Point__handle;
}
