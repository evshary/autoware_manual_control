...
cdr_serialize(
  const autoware_manual_control::msg::BoundedSequences & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::BoundedSequences & ros_message)
{
  // Member: bool_values
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::BoundedSequences;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::BoundedSequences *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::BoundedSequences *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::BoundedSequences>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_BoundedSequences__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, BoundedSequences)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_BoundedSequences__handle;
}
