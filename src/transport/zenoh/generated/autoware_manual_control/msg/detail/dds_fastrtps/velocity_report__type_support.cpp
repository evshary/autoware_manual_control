...
cdr_serialize(
  const autoware_manual_control::msg::VelocityReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::VelocityReport & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::VelocityReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::VelocityReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::VelocityReport *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VelocityReport__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::VelocityReport *>(
...
static size_t _VelocityReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VelocityReport(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VelocityReport__callbacks = {
...
static rosidl_message_type_support_t _VelocityReport__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VelocityReport__callbacks,
...
get_message_type_support_handle<autoware_manual_control::msg::VelocityReport>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_VelocityReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, VelocityReport)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_VelocityReport__handle;
}
