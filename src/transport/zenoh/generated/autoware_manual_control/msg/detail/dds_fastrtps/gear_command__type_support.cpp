...
cdr_serialize(
  const autoware_manual_control::msg::GearCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::GearCommand & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::GearCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::GearCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::GearCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::GearCommand>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_GearCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, GearCommand)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_GearCommand__handle;
}
