  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::Constants;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::Constants *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::Constants *>(
    untyped_ros_message);
...
static size_t _Constants__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Constants(full_bounded, is_plain, 0);
...
get_message_type_support_handle<autoware_manual_control::msg::Constants>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Constants__handle;
}
