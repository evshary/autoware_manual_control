...
#include "autoware_manual_control/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::Point &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::Point &);
...
{
bool cdr_serialize(
  const autoware_manual_control::msg::Quaternion &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_manual_control::msg::Quaternion &);
size_t get_serialized_size(
  const autoware_manual_control::msg::Quaternion &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const autoware_manual_control::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::Pose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  // Member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Point(
  ...
  // Member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_manual_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Quaternion(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::Pose *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::Pose>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, Pose)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
