...
cdr_serialize(
  const autoware_manual_control::msg::Defaults & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_manual_control::msg::Defaults & ros_message)
{
  // Member: bool_value
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_manual_control::msg::Defaults;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_manual_control::msg::Defaults *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_manual_control::msg::Defaults *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_manual_control::msg::Defaults>()
{
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Defaults__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_manual_control, msg, Defaults)() {
  return &autoware_manual_control::msg::typesupport_fastrtps_cpp::_Defaults__handle;
}
