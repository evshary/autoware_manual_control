...
#ifndef AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
#define AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_manual_control__msg__Defaults __attribute__((deprecated))
#else
# define DEPRECATED__autoware_manual_control__msg__Defaults __declspec(deprecated)
#endif
...
struct Defaults_
{
  ...
  explicit Defaults_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Defaults_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
  ...
  // pointer types
  using RawPtr =
    autoware_manual_control::msg::Defaults_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_manual_control::msg::Defaults_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_manual_control::msg::Defaults_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_manual_control__msg__Defaults
    std::shared_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_manual_control__msg__Defaults
    std::shared_ptr<autoware_manual_control::msg::Defaults_<ContainerAllocator> const>
...
using Defaults =
  autoware_manual_control::msg::Defaults_<std::allocator<void>>;
...
#endif  // AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
