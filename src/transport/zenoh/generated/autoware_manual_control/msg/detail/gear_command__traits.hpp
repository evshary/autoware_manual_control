...
#ifndef AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__GEAR_COMMAND__TRAITS_HPP_
#define AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__GEAR_COMMAND__TRAITS_HPP_
...
inline void to_yaml(
  const autoware_manual_control::msg::GearCommand & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_manual_control::msg::GearCommand & msg)
{
  return autoware_manual_control::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_manual_control::msg::GearCommand>()
{
  return "autoware_manual_control::msg::GearCommand";
}

template<>
inline const char * name<autoware_manual_control::msg::GearCommand>()
{
  return "autoware_manual_control/msg/GearCommand";
}

template<>
struct has_fixed_size<autoware_manual_control::msg::GearCommand>
  : std::integral_constant<bool, has_fixed_size<autoware_manual_control::msg::Time>::value> {};

template<>
struct has_bounded_size<autoware_manual_control::msg::GearCommand>
  : std::integral_constant<bool, has_bounded_size<autoware_manual_control::msg::Time>::value> {};

template<>
struct is_message<autoware_manual_control::msg::GearCommand>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__GEAR_COMMAND__TRAITS_HPP_
