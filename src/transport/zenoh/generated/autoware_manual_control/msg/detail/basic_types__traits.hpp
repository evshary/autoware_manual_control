...
#ifndef AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
#define AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
...
inline std::string to_yaml(const BasicTypes & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const autoware_manual_control::msg::BasicTypes & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_manual_control::msg::BasicTypes & msg)
{
  return autoware_manual_control::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_manual_control::msg::BasicTypes>()
{
  return "autoware_manual_control::msg::BasicTypes";
}

template<>
inline const char * name<autoware_manual_control::msg::BasicTypes>()
{
  return "autoware_manual_control/msg/BasicTypes";
}

template<>
struct has_fixed_size<autoware_manual_control::msg::BasicTypes>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<autoware_manual_control::msg::BasicTypes>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<autoware_manual_control::msg::BasicTypes>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
