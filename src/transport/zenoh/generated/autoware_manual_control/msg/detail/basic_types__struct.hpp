...
#ifndef AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__STRUCT_HPP_
#define AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_manual_control__msg__BasicTypes __attribute__((deprecated))
#else
# define DEPRECATED__autoware_manual_control__msg__BasicTypes __declspec(deprecated)
#endif
...
struct BasicTypes_
{
  ...
  using ConstRawPtr =
    const autoware_manual_control::msg::BasicTypes_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_manual_control__msg__BasicTypes
    std::shared_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_manual_control__msg__BasicTypes
    std::shared_ptr<autoware_manual_control::msg::BasicTypes_<ContainerAllocator> const>
...
using BasicTypes =
  autoware_manual_control::msg::BasicTypes_<std::allocator<void>>;
...
#endif  // AUTOWARE_MANUAL_CONTROL__MSG__DETAIL__BASIC_TYPES__STRUCT_HPP_
